      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            ChainFlow was created by professional traders who witnessed the sketchy, self-serving prop firm industry and
            decided to build something better—a fair, transparent firm that actually helps traders succeed.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                transparency, eliminate evaluation costs, and ensure every trade is publicly verifiable. We're not just
                another prop firm—we're reimagining what prop trading should be.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ChainFlow is powered by the Paxeer Network, a revolutionary blockchain infrastructure designed to create a
              fairer, more accessible, and more efficient global economy.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-card border border-border rounded-2xl p-8">
              ...
              <p className="text-muted-foreground mb-4">
                Our custom EVM-compatible chain for evaluation accounts. Every evaluation trade is recorded on OpenNet,
                providing complete transparency during your challenge phase.
              </p>
              <a
