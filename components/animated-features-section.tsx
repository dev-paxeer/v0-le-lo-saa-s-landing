      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4" style={{ fontFamily: "var(--font-playfair)" }}>
            Revolutionary On-Chain Trading
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience complete transparency with blockchain-verified trades and zero evaluation costs
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="$0 Fees"
              subtitle="No upfront costs. Start your evaluation on OpenNet without any financial barriers"
              colors={["#1a1a1a", "#2a2a2a", "#1f1f1f"]}
              delay={0.2}
            />
          </div>
          <a href="https://opennet.paxeer.app" target="_blank" rel="noopener noreferrer" className="block h-full">
            <BentoCard
              title="Public Ledger"
              value="100%"
              subtitle="Fully transparent trades - View on OpenNet Explorer"
          ...
          <a href="https://opennet.paxeer.app" target="_blank" rel="noopener noreferrer" className="block h-full">
            <BentoCard
              title="OpenNet EVM Chain"
              value="Eval"
              subtitle="Dedicated blockchain for evaluations - Explore the network"
              colors={["#1c1c1c", "#2c2c2c", "#181818"]}
              delay={0.6}
            />
          </a>
          <div className="md:col-span-2">
            <a href="https://paxscan.paxeer.app" target="_blank" rel="noopener noreferrer" className="block h-full">
              <BentoCard
                title="Paxeer Live Network"
                value="Mainnet"
                subtitle="Trade on our live mainnet once funded - View on Paxscan"
          ...
          <div className="md:col-span-3">
            <BentoCard
              title="Blockchain Verified & Immutable Records"
              value="On-Chain"
              subtitle="Every trade recorded on the blockchain. Verifiable, transparent, and tamper-proof trading history"
